			   ...
			   <style>div.updated.suwpremote,
				   ...
				   @media screen and (min-width: 280px) {
					   ...
					   div.updated.suwpremote header {
						   background: #fff;
						   color: <?php echo $dismiss_0_color ?>;
						   position: relative;
						   height: 5rem;
					   }
					   div.updated.suwpremote header img {
					   ...
					   div.updated.suwpremote .mailchimp form input#mce-EMAIL:focus + input.submit-button {
						   background: <?php echo $dismiss_0_color ?>;
					   }
				   ...
				   <div class="updated suwpremote">
					   <header>
						   <!-- Logo -->
						   <img src="<?php echo $dismiss_0_image; ?>"  class="suwp-logo"/>
						   
						   <!-- Message -->
						   <h3><?php _e( $dismiss_0_msg,'suwpremote'); ?></h3>
						   ...
						   <!-- The Dismiss Button -->
							...
							$remote_banner_exit_href = $plugin_admin->suwp_get_remote_notice_ignore_link('0');
							
							if (is_object( get_current_screen() ) ) {
								
								$screen = get_current_screen();
								$suwp_remote_href = admin_url() . $remote_banner_exit_href . '&screen_id_url=' . $screen->id ;
							}
							
							?>
							
						   <?php _e('<a href="' . $suwp_remote_href . '" class="dismiss"></a>', 'suwpremote') ?>
					   </header>
					   ...
					   <div class="suwpremote-actions">
						   ...
						   <div class="suwpremote-action">
							   <a href="<?php echo $dismiss_0_dashlink; ?>" <?php echo $dismiss_0_dashtarget; ?> >
								   <span class="dashicons dashicons-info"></span><?php _e( $dismiss_0_dashtxt, 'suwpremote'); ?>
							   </a>
						   </div>
					   </div>
				   </div>
